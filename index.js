...
var withBackbone = function withBackbone(WrappedComponent) {
    var WithBackbone = function (_React$Component) {
        ...
        function WithBackbone(props) {
            ...
            _this.modelListener = _extends({}, _backbone2.default.Events);
            ...
            _this.collectionListener = _extends({}, _backbone2.default.Events);
            ...
            _this.debouncedForceUpdate = (0, _lodash2.default)(_this.forceUpdateWrapper, 0);
            return _this;
        }
